...
const HomePage = () => {
  ...
  const fetchBoards = async () => {
    try {
      const response = await axios.get("https://kudos-board-exemplar-bck7.onrender.com/boards");
  ...
  const deleteBoard = async (boardId) => {
    try {
      const response = await fetch(`https://kudos-board-exemplar-bck7.onrender.com/boards/${boardId}`, {
        method: "DELETE",
        headers: {
