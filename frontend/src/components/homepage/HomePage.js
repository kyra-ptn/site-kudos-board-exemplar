...
const HomePage = () => {
  ...
  const fetchBoards = async () => {
    try {
      const response = await axios.get("https://site-kudos-board-exemplar.onrender.com/boards");
  ...
  const deleteBoard = async (boardId) => {
    try {
      const response = await fetch(`https://site-kudos-board-exemplar.onrender.com/boards/${boardId}`, {
        method: "DELETE",
        headers: {
